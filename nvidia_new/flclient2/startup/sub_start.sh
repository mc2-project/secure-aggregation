...
start_fl() {
  ...
  lst=$SECONDS
((stdbuf -o 0 -e 0 python3 -u -m nvmidl.apps.fed_learn.client.admin_local_train -m $DIR/.. -s fed_client.json --set secure_train=true uid=flclient2 2>&1 & echo $! >&3 ) 3>$DIR/../pid.fl | tee -a $DIR/../log.txt &)
  pid=`cat $DIR/../pid.fl`
}
