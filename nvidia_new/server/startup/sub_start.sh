...
start_fl() {
  ...
  lst=$SECONDS
((stdbuf -o 0 -e 0 python3 -u -m nvmidl.apps.fed_learn.server.admin_fed_aggregate -m $DIR/.. -s fed_server.json --set secure_train=true 2>&1 & echo $! >&3 ) 3>$DIR/../pid.fl | tee -a $DIR/../log.txt &)
  pid=`cat $DIR/../pid.fl`
}
