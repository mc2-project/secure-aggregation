...
class CustomModelAggregator(Aggregator):
    ...
    def process(self, accumulator, fl_ctx):
        ...
        model = fl_ctx.get_model()
        print("In aggregation server global model protobuf size: ", model.ByteSize())
        ...
        print("In aggregation, local model update protobuf size: ", accumulator[0].get_model().ByteSize())
        ...
        print("In aggregation, new server global model protobuf size: ", fl_ctx.model.ByteSize())
